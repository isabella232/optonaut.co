        ...
        <div className='container' id='section-faq-content'>
          ...
          <div className='row'>
            <div className='one-half column'>
              ...
              Optonaut for Android will be released by the end of August. 
              The iOS version will be released two months later.
            </div>
            <div className='one-half column'>
              <strong>What is Optonaut going to cost?</strong><br/>
              Optonaut will be free. We sell your data instead. <br /><br />Just kidding. ;)
            </div>
          </div>
          <div className='row'>
            <div className='one-half column'>
              ...
              At the moment we need to transmit those data since the 3D conversion process is very memory intense. 
