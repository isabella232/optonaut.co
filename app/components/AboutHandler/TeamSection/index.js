            ...
            <div className={styles.person}>
              ...
              <div className={styles.personInfo}>
                ...
                <div className={styles.personBio}>
                  Johannes built his first startup at the age of 17, where he learned all what it takes to turn an idea to a business. Having a degree in computer science and a background in design combined with his obsession for virtual reality, Optonaut was the next logcial step.
                </div>
              </div>
            </div>
            <div className={styles.person}>
