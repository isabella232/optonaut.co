    ...
    return (
      <div id='section-hardware'>
        <div className='container' id='section-hardware-content'>
          ...
          <div id='section-hardware-explanation'>* This solution is the most affordable we could think of. But if you are willing to spend the extra dollar, we provide you with a <Link to='/'>3D lense from our partner Kula.</Link>.</div>
        </div>
      </div>
    );
  }
